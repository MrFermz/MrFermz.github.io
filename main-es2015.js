...
let MemberComponent = class MemberComponent {
    ...
    getMemberAll() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            yield this.memberService.getMemberAll()
                .subscribe(data => {
                console.log(data);
                this.items = data;
            });
    ...
    onDelete(item) {
        ...
        swal({
            ...
            this.memberService.deleteMember(item);
            swal({
...
let BackendurlService = class BackendurlService {
    constructor() {
...
let MemberService = class MemberService {
    ...
    postMember(record) {
        // console.log(record);
        const url = this.backendUrl.url + 'post_member_api.php';
        this.http.post(url, JSON.stringify(record), this.httpOption).subscribe();
    }
    getMemberAll() {
        const url = this.backendUrl.url + 'get_member_api.php';
        return this.http.get(url);
    }
    deleteMember(item) {
        // console.log(id);
        const url = this.backendUrl.url + 'delete_member_api.php';
        this.http.post(url, JSON.stringify(item), this.httpOption).subscribe();
    }
    updateMember(record) {
        // console.log(record);
        const url = this.backendUrl.url + 'update_member_api.php';
        this.http.post(url, JSON.stringify(record), this.httpOption).subscribe();
    }
};
